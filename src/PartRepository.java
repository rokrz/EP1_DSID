...
public interface PartRepository extends Remote{
	...
	public boolean addPartToRepo(String name, String desc, ArrayList<Pair<Integer,Integer>> components) throws RemoteException; //Adiciona uma nova parte à lista. Recebe como parametro o nome e a descrição, e dento do metodo cria a nova parte, com um ID procedural e a Lista atual de subpartes
